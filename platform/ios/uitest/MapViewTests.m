...
#import <MGeoMap/Geocompass.h>
#import "GCLTViewController.h"

#import <CoreLocation/CoreLocation.h>

@interface MapViewTests : KIFTestCase <GCLMapViewDelegate>
...
- (BOOL)mapView:(GCLMapView *)mapView annotationCanShowCallout:(id<MGLAnnotation>)annotation {
    return YES;
}
