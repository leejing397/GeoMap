...
@interface GCLMapView (IBAdditions)
...
// inspectables declared in GCLMapView.h are always sorted before those in
// GCLMapView+IBAdditions.h, due to ASCII sort order.
