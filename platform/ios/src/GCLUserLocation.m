...
@implementation GCLUserLocation
...
- (BOOL)isEqual:(id)other {
    ...
    if (![other isKindOfClass:[GCLUserLocation class]]) return NO;

    GCLUserLocation *otherUserLocation = other;
...
- (BOOL)isUpdating
{
    return self.mapView.userTrackingMode != GCLUserTrackingModeNone;
}
