...
@implementation GCLAnnotationImage
...
- (BOOL)isEqual:(id)other {
    ...
    if (![other isKindOfClass:[GCLAnnotationImage class]]) return NO;

    GCLAnnotationImage *otherAnnotationImage = other;
