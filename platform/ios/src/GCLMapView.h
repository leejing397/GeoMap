...
@class GCLAnnotationImage;
@class GCLUserLocation;
@class GCLPolyline;
@class GCLPolygon;
@class GCLShape;
@class GCLStyle;

@protocol GCLMapViewDelegate;
@protocol GCLAnnotation;
@protocol GCLOverlay;
@protocol GCLCalloutView;
@protocol GCLFeature;

/** The default deceleration rate for a map view. */
extern GCL_EXPORT const CGFloat GCLMapViewDecelerationRateNormal;

/** A fast deceleration rate for a map view. */
extern GCL_EXPORT const CGFloat GCLMapViewDecelerationRateFast;

/** Disables deceleration in a map view. */
extern GCL_EXPORT const CGFloat GCLMapViewDecelerationRateImmediate;

/**
 The vertical alignment of an annotation within a map view. Used with
 `GCLMapView.userLocationVerticalAlignment`.
 */
typedef NS_ENUM(NSUInteger, GCLAnnotationVerticalAlignment) {
    /** Aligns the annotation vertically in the center of the map view. */
    GCLAnnotationVerticalAlignmentCenter = 0,
    /** Aligns the annotation vertically at the top of the map view. */
    GCLAnnotationVerticalAlignmentTop,
    /** Aligns the annotation vertically at the bottom of the map view. */
    GCLAnnotationVerticalAlignmentBottom,
};

/**
 地图上显示当前位置的方式. 调用方式：
 `GCLMapView.userTrackingMode`.
 */
typedef NS_ENUM(NSUInteger, GCLUserTrackingMode) {
    /** 地图不跟随当前位置移动. */
    GCLUserTrackingModeNone              = 0,
    /** 地图随当前位置移动。 如果用户手动移动地图的话，模式回退到  `GCLUserTrackingModeNone` */
    GCLUserTrackingModeFollow,
    /**
        地图跟随当前位置移动，且旋转角度与当前设备的指向一致.
        默认的当前位置注记使用一个箭头指示当前设备的朝向。
     
        如果用户移动了地图当前模式会失效,而缩放地图不会. 用户旋转了地图，模式回退到 `GCLUserTrackingModeFollow`.
     */
    GCLUserTrackingModeFollowWithHeading,
    /**
        ...
        this tracking mode will fall back to `GCLUserTrackingModeFollow`.
     */
    GCLUserTrackingModeFollowWithCourse,
};
...
/**
 ...
 Using `GCLMapView`, you can embed the map inside a view, allow users to
 ...
 A collection of Mapbox-hosted styles is available through the `GCLStyle`
 ...
 Adding your own gesture recognizer to `GCLMapView` will block the corresponding
 gesture recognizer built into `GCLMapView`. To avoid conflicts, define which
 gesture takes precedence. For example, you can create your own
 `UITapGestureRecognizer` that will be invoked only if the default `GCLMapView`
 tap gesture fails:
 ...
 */
GCL_EXPORT IB_DESIGNABLE
@interface GCLMapView : UIView
...
/**
 ...
 annotations.
 */
@property(nonatomic, weak, nullable) IBOutlet id<GCLMapViewDelegate> delegate;
...
/**
 ...
 `-[GCLMapViewDelegate mapView:didFinishLoadingStyle:]` or
 `-[GCLMapViewDelegate mapViewDidFinishLoadingMap:]` method. It is not possible
 ...
 @note The default styles provided by Mapbox contain sources and layers with
    ...
    `+[GCLStyle outdoorsStyleURLWithVersion:]`, `GCLMapView`’s “Style URL”
    inspectable in Interface Builder, or a manually constructed `NSURL`.
 */
@property (nonatomic, readonly, nullable) GCLStyle *style;

/**
 URLs of the styles bundled with the library.

 @deprecated Call the relevant class method of `GCLStyle` for the URL of a
    particular default style.
 */
@property (nonatomic, readonly) NS_ARRAY_OF(NSURL *) *bundledStyleURLs __attribute__((deprecated("Call the relevant class method of GCLStyle for the URL of a particular default style.")));
 ...
 */
@property (nonatomic, readonly, nullable) GCLUserLocation *userLocation;

/**
 The mode used to track the user location. The default value is
 `GCLUserTrackingModeNone`.
 ...
 */
@property (nonatomic, assign) GCLUserTrackingMode userTrackingMode;
...
/**
 ...
 default value is `GCLAnnotationVerticalAlignmentCenter`.

 Changing the value of this property updates the map view with an animated
 transition. If you don’t want to animate the change, use the
 `-setUserLocationVerticalAlignment:animated:` method instead.
 */
@property (nonatomic, assign) GCLAnnotationVerticalAlignment userLocationVerticalAlignment;
...
/**
 ...
 `GCLUserTrackingModeFollowWithHeading` or
 `GCLUserTrackingModeFollowWithCourse`.
...
/**
 ...
 value other than `GCLUserTrackingModeFollowWithCourse`.
...
/**
 ...
 other than `GCLUserTrackingModeFollowWithCourse`.
...
/**
 ...
 Your application can use the `GCLMapViewDecelerationRateNormal` and
 `GCLMapViewDecelerationRateFast` constants as reference points for reasonable
 deceleration rates. `GCLMapViewDecelerationRateImmediate` can be used to
...
/**
 ...
 instead.
 */
@property (nonatomic) GCLCoordinateBounds visibleCoordinateBounds;
 ...
 */
@property (nonatomic, copy) GCLMapCamera *camera;
...
/**
 ...
 If the `userTrackingMode` property is not `GCLUserTrackingModeNone`, the
...
/**
 ...
 The objects in this array must adopt the `GCLAnnotation` protocol. If no
 annotations are associated with the map view, the value of this property is
 `nil`.
 */
@property (nonatomic, readonly, nullable) NS_ARRAY_OF(id <GCLAnnotation>) *annotations;

/**
 Adds an annotation to the map view.

 @note `GCLMultiPolyline`, `GCLMultiPolygon`, `GCLShapeCollection`, and
    `GCLPointCollection` objects cannot be added to the map view at this time.
 ...
 @param annotation The annotation object to add to the receiver. This object
    must conform to the `GCLAnnotation` protocol. The map view retains the
    annotation object. */
...
/**
 ...
 @note `GCLMultiPolyline`, `GCLMultiPolygon`, and `GCLShapeCollection` objects
    cannot be added to the map view at this time. Nor can `GCLMultiPoint`
    objects that are not instances of `GCLPolyline` or `GCLPolygon`. Any
    multipoint, multipolyline, multipolygon, or shape collection objects that
    are specified are silently ignored.

 @param annotations An array of annotation objects. Each object in the array
    must conform to the `GCLAnnotation` protocol. The map view retains each
...
/**
 ...
 @param annotations The array of annotation objects to remove. Objects in the
    array must conform to the `GCLAnnotation` protocol.
 */
- (void)removeAnnotations:(NS_ARRAY_OF(id <GCLAnnotation>) *)annotations;

/**
 Returns an `GCLAnnotationView` if the given annotation is currently associated
 with a view, otherwise nil.

 @param annotation The annotation associated with the view.
    Annotation must conform to the `GCLAnnotation` protocol.
 */
...
/**
 ...
 For performance reasons, you should generally reuse `GCLAnnotationImage`
 ...
 */
- (nullable __kindof GCLAnnotationImage *)dequeueReusableAnnotationImageWithIdentifier:(NSString *)identifier;

/**
 Returns a reusable annotation view object associated with its identifier.

 For performance reasons, you should generally reuse `GCLAnnotationView`
 objects for identical-looking annotations in your map views. Dequeueing
 saves time and memory during performance-critical operations such as
 scrolling.
 ...
 @return An annotation view object with the given identifier, or `nil` if no
    such object exists in the reuse queue.
 */
- (nullable __kindof GCLAnnotationView *)dequeueReusableAnnotationViewWithIdentifier:(NSString *)identifier;
 ...
 */
@property (nonatomic, readonly, nullable) NS_ARRAY_OF(id <GCLAnnotation>) *visibleAnnotations;
...
/**
 ...
 @return An array of objects that adopt the `GCLAnnotation` protocol or `nil` if
...
/**
 ...
 the array.
 */
@property (nonatomic, copy) NS_ARRAY_OF(id <GCLAnnotation>) *selectedAnnotations;
 ...
 */
- (void)deselectAnnotation:(nullable id <GCLAnnotation>)annotation animated:(BOOL)animated;
...
/**
 ...
 The objects in this array must adopt the `GCLOverlay` protocol. If no
 overlays are associated with the map view, the value of this property is
 empty array.
 */
@property (nonatomic, readonly, nonnull) NS_ARRAY_OF(id <GCLOverlay>) *overlays;
...
/**
 ...
 @param overlays An array of objects, each of which conforms to the `GCLOverlay`
    protocol.
 */
 ...
 */
- (NS_ARRAY_OF(id <GCLFeature>) *)visibleFeaturesAtPoint:(CGPoint)point NS_SWIFT_NAME(visibleFeatures(at:));
...
/**
 ...
 @return An array of objects conforming to the `GCLFeature` protocol that 
    represent features in the sources used by the current style.
 */
- (NS_ARRAY_OF(id <GCLFeature>) *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NS_SET_OF(NSString *) *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:));
...
/**
 ...
 `GCLShapeSource` and `GCLVectorSource` objects but does not include anything
 from `GCLRasterSource` objects, or from image, video, or canvas sources, which
 ...
 `GCLFeature` object representing that bus stop is returned and its
 ...
 visibility, use the
 `-[GCLVectorSource featuresInSourceLayersWithIdentifiers:predicate:]` and
 `-[GCLShapeSource featuresMatchingPredicate:]` methods on the relevant sources.

 The returned features may also include features corresponding to annotations.
 These features are not object-equal to the `GCLAnnotation` objects that were
 originally added to the map. To query the map for annotations, use
 `visibleAnnotations` or `-[GCLMapView visibleAnnotationsInRect:]`.

 @note Layer identifiers are not guaranteed to exist across styles or different
    versions of the same style. Applications that use this API must first set
    the style URL to an explicitly versioned style using a convenience method
    like `+[GCLStyle outdoorsStyleURLWithVersion:]`, `GCLMapView`’s “Style URL”
 ...
 @return An array of objects conforming to the `GCLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NS_ARRAY_OF(id <GCLFeature>) *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NS_SET_OF(NSString *) *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:predicate:));
...
/**
 ...
 @return An array of objects conforming to the `GCLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NS_ARRAY_OF(id <GCLFeature>) *)visibleFeaturesInRect:(CGRect)rect NS_SWIFT_NAME(visibleFeatures(in:));
...
/**
 ...
 @return An array of objects conforming to the `GCLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NS_ARRAY_OF(id <GCLFeature>) *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NS_SET_OF(NSString *) *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:));
...
/**
 ...
 array. On the other hand, if the style does include bus stops, an `GCLFeature`
 ...
 @return An array of objects conforming to the `GCLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NS_ARRAY_OF(id <GCLFeature>) *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NS_SET_OF(NSString *) *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:predicate:));
 ...
 */
@property (nonatomic) GCLMapDebugMaskOptions debugMask;
