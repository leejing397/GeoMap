...
@implementation GCLUserLocationHeadingBeamLayer
{
...
{
    CGFloat size = GCLUserLocationAnnotationHaloSize;
...
- (CGImageRef)gradientImageWithTintColor:(CGColorRef)tintColor
{
    ...
    CGFloat haloRadius = GCLUserLocationAnnotationHaloSize / 2.0;

    UIGraphicsBeginImageContextWithOptions(CGSizeMake(GCLUserLocationAnnotationHaloSize, haloRadius), NO, 0);
...
- (CGPathRef)clippingMaskForAccuracy:(CGFloat)accuracy
{
    ...
    CGRect ovalRect = CGRectMake(0, 0, GCLUserLocationAnnotationHaloSize, GCLUserLocationAnnotationHaloSize);
    ...
    [ovalPath addArcWithCenter:CGPointMake(CGRectGetMidX(ovalRect), CGRectGetMidY(ovalRect))
                    ...
                    startAngle:GCLRadiansFromDegrees(-180 + clippingDegrees)
                      endAngle:GCLRadiansFromDegrees(-clippingDegrees)
                     clockwise:YES];
