...
/**
 The `GCLMapViewDelegate` protocol defines a set of optional methods that you
 can use to receive map-related update messages. Because many map operations
 require the `GCLMapView` class to load data asynchronously, the map view calls
 ...
 */
@protocol GCLMapViewDelegate <NSObject>
 ...
 */
- (void)mapView:(GCLMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
...
/**
 ...
 as `-[GCLMapView setCamera:animated:]`. This method can be called before
 ...
 */
- (BOOL)mapView:(GCLMapView *)mapView shouldChangeFromCamera:(GCLMapCamera *)oldCamera toCamera:(GCLMapCamera *)newCamera;
 ...
 */
- (void)mapViewWillStartLoadingMap:(GCLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(GCLMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(GCLMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(GCLMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(GCLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(GCLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(GCLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartLocatingUser:(GCLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(GCLMapView *)mapView;
...
/**
 ...
 `GCLUserTrackingModeFollowWithHeading` and the heading changes, or if it is set
 to `GCLUserTrackingModeFollowWithCourse` and the course changes.
 ...
 */
- (void)mapView:(GCLMapView *)mapView didUpdateUserLocation:(nullable GCLUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(GCLMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
...
/**
 ...
 @param animated Whether the change caused an animated effect on the map.
 */
- (void)mapView:(GCLMapView *)mapView didChangeUserTrackingMode:(GCLUserTrackingMode)mode animated:(BOOL)animated;
 ...
 */
- (nullable GCLAnnotationImage *)mapView:(GCLMapView *)mapView imageForAnnotation:(id <GCLAnnotation>)annotation;
 ...
 */
- (CGFloat)mapView:(GCLMapView *)mapView alphaForShapeAnnotation:(GCLShape *)annotation;
 ...
 */
- (UIColor *)mapView:(GCLMapView *)mapView strokeColorForShapeAnnotation:(GCLShape *)annotation;
 ...
 */
- (UIColor *)mapView:(GCLMapView *)mapView fillColorForPolygonAnnotation:(GCLPolygon *)annotation;
 ...
 */
- (CGFloat)mapView:(GCLMapView *)mapView lineWidthForPolylineAnnotation:(GCLPolyline *)annotation;
...
/**
 ...
 `annotation` is an instance of `GCLUserLocation` (or equal to the map view’s
 `userLocation` property), return an instance of `GCLUserLocationAnnotationView`
 ...
 */
- (nullable GCLAnnotationView *)mapView:(GCLMapView *)mapView viewForAnnotation:(id <GCLAnnotation>)annotation;
...
/**
 ...
 @param annotationViews An array of `GCLAnnotationView` objects representing the
    views that were added.
 */
- (void)mapView:(GCLMapView *)mapView didAddAnnotationViews:(NS_ARRAY_OF(GCLAnnotationView *) *)annotationViews;
 ...
 */
- (void)mapView:(GCLMapView *)mapView didSelectAnnotation:(id <GCLAnnotation>)annotation;
 ...
 */
- (void)mapView:(GCLMapView *)mapView didDeselectAnnotation:(id <GCLAnnotation>)annotation;
 ...
 */
- (void)mapView:(GCLMapView *)mapView didSelectAnnotationView:(GCLAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(GCLMapView *)mapView didDeselectAnnotationView:(GCLAnnotationView *)annotationView;
...
/**
 ...
 @return A Boolean value indicating whether the annotation should show a
    callout.
 */
- (BOOL)mapView:(GCLMapView *)mapView annotationCanShowCallout:(id <GCLAnnotation>)annotation;
...
/**
 ...
 @param annotation The object representing the annotation.
 @return A view conforming to the `GCLCalloutView` protocol, or `nil` to use the
    default callout view.
 */
- (nullable id <GCLCalloutView>)mapView:(GCLMapView *)mapView calloutViewForAnnotation:(id <GCLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(GCLMapView *)mapView leftCalloutAccessoryViewForAnnotation:(id <GCLAnnotation>)annotation;
...
/**
 ...
 @return The accessory view to display.
 */
- (nullable UIView *)mapView:(GCLMapView *)mapView rightCalloutAccessoryViewForAnnotation:(id <GCLAnnotation>)annotation;
...
/**
 ...
 custom accessory views using the `GCLCalloutView` protocol’s
 ...
 */
- (void)mapView:(GCLMapView *)mapView annotation:(id <GCLAnnotation>)annotation calloutAccessoryControlTapped:(UIControl *)control;
...
/**
 ...
 `-[GCLCalloutViewDelegate calloutViewTapped:]` method.
