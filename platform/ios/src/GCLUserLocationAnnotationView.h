...
/** View representing an `GCLUserLocation` on screen. */
GCL_EXPORT
@interface GCLUserLocationAnnotationView : GCLAnnotationView
 ...
 */
@property (nonatomic, readonly, weak, nullable) GCLMapView *mapView;
...
/**
 ...
 is inactive.
 */
@property (nonatomic, readonly, weak, nullable) GCLUserLocation *userLocation;
