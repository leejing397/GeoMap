...
@interface MBXBenchViewController () <GCLMapViewDelegate>
...
- (void)viewDidLoad
{
    ...
    self.mapView = [[GCLMapView alloc] initWithFrame:self.view.bounds styleURL:url];
...
- (void)mapViewDidFinishRenderingFrame:(GCLMapView *)mapView fullyRendered:(__unused BOOL)fullyRendered
{
