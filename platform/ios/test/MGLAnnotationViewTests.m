...
@property (nonatomic, readwrite) GCLAnnotationViewDragState dragState;
- (void)setDragState:(GCLAnnotationViewDragState)dragState;

@end

@interface GCLMapView (Test)
...
@interface MGLAnnotationViewTests : XCTestCase <GCLMapViewDelegate>
...
{
    [super setUp];
    _mapView = [[GCLMapView alloc] initWithFrame:CGRectMake(0, 0, 64, 64)];
...
- (void)testAnnotationView
{
    ...
    _annotationView.dragState = GCLAnnotationViewDragStateStarting;
...
- (MGLAnnotationView *)mapView:(GCLMapView *)mapView viewForAnnotation:(id<MGLAnnotation>)annotation
{
...
- (void)mapView:(GCLMapView *)mapView didAddAnnotationViews:(NSArray<MGLAnnotationView *> *)annotationViews
{
