...
- (void)setDragState:(GCLAnnotationViewDragState)dragState animated:(BOOL)animated
{
    ...
    switch (dragState) {
        case GCLAnnotationViewDragStateNone:
            break;
        case GCLAnnotationViewDragStateStarting: {
        ...
        case GCLAnnotationViewDragStateDragging:
            break;
        case GCLAnnotationViewDragStateCanceling:
            break;
        case GCLAnnotationViewDragStateEnding: {
            self.transform = CGAffineTransformScale(CGAffineTransformIdentity, 2, 2);
            [UIView animateWithDuration:.4 delay:0 usingSpringWithDamping:.4 initialSpringVelocity:.5 options:UIViewAnimationOptionCurveLinear animations:^{
