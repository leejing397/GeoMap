...
- (CGSize)intrinsicContentSize
{
    ...
    return (self.mapView.userTrackingMode == GCLUserTrackingModeFollowWithCourse) ? carSize : [self dotSize];
}
...
{
    (self.mapView.userTrackingMode == GCLUserTrackingModeFollowWithCourse) ? [self drawCar] : [self drawDot];
}
