...
if [[ ${BUILD_STATIC} == true ]]; then
    ...
    cat platform/ios/framework/Mapbox-static.h > "${OUTPUT}/static/${NAME}.framework/Headers/Geocompass.h"
    cat "${PRODUCTS}/${BUILDTYPE}-iphoneos/Headers/Geocompass.h" >> "${OUTPUT}/static/${NAME}.framework/Headers/Geocompass.h"
fi
