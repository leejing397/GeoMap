...
class MGLDocumentationExampleTests: XCTestCase, MGLMapViewDelegate {
    ...
    override func setUp() {
        ...
        mapView = GCLMapView(frame: CGRect(x: 0, y: 0, width: 256, height: 256), styleURL: styleURL)
    ...
    func mapView(_ mapView: GCLMapView, didFinishLoading style: GCLStyle) {
    ...
    func testMGLShape$shapeWithData_encoding_error_() {
        ...
        let feature = try! GCLShape(data: data, encoding: String.Encoding.utf8.rawValue) as! MGLShapeCollectionFeature
        //#-end-example-code
    ...
    func testMGLMapSnapshotter() {
        ...
        let options = MGLMapSnapshotOptions(styleURL: GCLStyle.satelliteStreetsStyleURL(), camera: camera, size: CGSize(width: 320, height: 480))
