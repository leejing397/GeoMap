...
- (void)testProperties {
    ...
    GCLTransition transitionTest = GCLTransitionMake(5, 4);
    ...
    // icon-pitch-alignment
    {
        ...
        MGLStyleValue<NSValue *> *constantStyleValue = [MGLStyleValue<NSValue *> valueWithRawValue:[NSValue valueWithGCLIconPitchAlignment:GCLIconPitchAlignmentAuto]];
    ...
    // icon-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.iconColor;

        MGLStyleValue<GCLColor *> *constantStyleValue = [MGLStyleValue<GCLColor *> valueWithRawValue:[GCLColor redColor]];
        ...
        MGLStyleValue<GCLColor *> * functionStyleValue = [MGLStyleValue<GCLColor *> valueWithInterpolationMode:MGLInterpolationModeInterval cameraStops:@{@18: constantStyleValue} options:nil];
        ...
        functionStyleValue = [MGLStyleValue<GCLColor *> valueWithInterpolationMode:MGLInterpolationModeExponential sourceStops:@{@18: constantStyleValue} attributeName:@"keyName" options:nil];
        layer.iconColor = functionStyleValue;
        ...
        functionStyleValue = [MGLStyleValue<GCLColor *> valueWithInterpolationMode:MGLInterpolationModeExponential compositeStops:@{@10: @{@18: constantStyleValue}} attributeName:@"keyName" options:nil];
        layer.iconColor = functionStyleValue;
        ...
        GCLTransition iconColorTransition = layer.iconColorTransition;
    ...
    // icon-halo-blur
    {
        ...
        GCLTransition iconHaloBlurTransition = layer.iconHaloBlurTransition;
    ...
    // icon-halo-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.iconHaloColor;
        ...
        GCLTransition iconHaloColorTransition = layer.iconHaloColorTransition;
    ...
    // icon-halo-width
    {
        ...
        GCLTransition iconHaloWidthTransition = layer.iconHaloWidthTransition;
    ...
    // icon-opacity
    {
        ...
        GCLTransition iconOpacityTransition = layer.iconOpacityTransition;
    ...
    // text-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.textColor;
        ...
        GCLTransition textColorTransition = layer.textColorTransition;
    ...
    // text-halo-blur
    {
        ...
        GCLTransition textHaloBlurTransition = layer.textHaloBlurTransition;
    ...
    // text-halo-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.textHaloColor;
        ...
        GCLTransition textHaloColorTransition = layer.textHaloColorTransition;
    ...
    // text-halo-width
    {
        ...
        GCLTransition textHaloWidthTransition = layer.textHaloWidthTransition;
    ...
    // text-opacity
    {
        ...
        GCLTransition textOpacityTransition = layer.textOpacityTransition;
...
- (void)testValueAdditions {
    ...
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorLeft].GCLIconAnchorValue, GCLIconAnchorLeft);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorRight].GCLIconAnchorValue, GCLIconAnchorRight);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorTop].GCLIconAnchorValue, GCLIconAnchorTop);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorBottom].GCLIconAnchorValue, GCLIconAnchorBottom);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorTopLeft].GCLIconAnchorValue, GCLIconAnchorTopLeft);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorTopRight].GCLIconAnchorValue, GCLIconAnchorTopRight);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorBottomLeft].GCLIconAnchorValue, GCLIconAnchorBottomLeft);
    XCTAssertEqual([NSValue valueWithGCLIconAnchor:GCLIconAnchorBottomRight].GCLIconAnchorValue, GCLIconAnchorBottomRight);
    XCTAssertEqual([NSValue valueWithGCLIconPitchAlignment:GCLIconPitchAlignmentMap].GCLIconPitchAlignmentValue, GCLIconPitchAlignmentMap);
    XCTAssertEqual([NSValue valueWithGCLIconPitchAlignment:GCLIconPitchAlignmentViewport].GCLIconPitchAlignmentValue, GCLIconPitchAlignmentViewport);
    XCTAssertEqual([NSValue valueWithGCLIconPitchAlignment:GCLIconPitchAlignmentAuto].GCLIconPitchAlignmentValue, GCLIconPitchAlignmentAuto);
    ...
    XCTAssertEqual([NSValue valueWithGCLIconRotationAlignment:GCLIconRotationAlignmentViewport].GCLIconRotationAlignmentValue, GCLIconRotationAlignmentViewport);
    XCTAssertEqual([NSValue valueWithGCLIconRotationAlignment:GCLIconRotationAlignmentAuto].GCLIconRotationAlignmentValue, GCLIconRotationAlignmentAuto);
    XCTAssertEqual([NSValue valueWithGCLIconTextFit:GCLIconTextFitNone].GCLIconTextFitValue, GCLIconTextFitNone);
    XCTAssertEqual([NSValue valueWithGCLIconTextFit:GCLIconTextFitWidth].GCLIconTextFitValue, GCLIconTextFitWidth);
    XCTAssertEqual([NSValue valueWithGCLIconTextFit:GCLIconTextFitHeight].GCLIconTextFitValue, GCLIconTextFitHeight);
    XCTAssertEqual([NSValue valueWithGCLIconTextFit:GCLIconTextFitBoth].GCLIconTextFitValue, GCLIconTextFitBoth);
    ...
    XCTAssertEqual([NSValue valueWithGCLSymbolPlacement:GCLSymbolPlacementLine].GCLSymbolPlacementValue, GCLSymbolPlacementLine);
    XCTAssertEqual([NSValue valueWithMGLTextAnchor:MGLTextAnchorCenter].MGLTextAnchorValue, MGLTextAnchorCenter);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorLeft].GCLTextAnchorValue, GCLTextAnchorLeft);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorRight].GCLTextAnchorValue, GCLTextAnchorRight);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorTop].GCLTextAnchorValue, GCLTextAnchorTop);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorBottom].GCLTextAnchorValue, GCLTextAnchorBottom);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorTopLeft].GCLTextAnchorValue, GCLTextAnchorTopLeft);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorTopRight].GCLTextAnchorValue, GCLTextAnchorTopRight);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorBottomLeft].GCLTextAnchorValue, GCLTextAnchorBottomLeft);
    XCTAssertEqual([NSValue valueWithGCLTextAnchor:GCLTextAnchorBottomRight].GCLTextAnchorValue, GCLTextAnchorBottomRight);
    XCTAssertEqual([NSValue valueWithGCLTextJustification:GCLTextJustificationLeft].GCLTextJustificationValue, GCLTextJustificationLeft);
    XCTAssertEqual([NSValue valueWithGCLTextJustification:GCLTextJustificationCenter].GCLTextJustificationValue, GCLTextJustificationCenter);
    XCTAssertEqual([NSValue valueWithGCLTextJustification:GCLTextJustificationRight].GCLTextJustificationValue, GCLTextJustificationRight);
    XCTAssertEqual([NSValue valueWithGCLTextPitchAlignment:GCLTextPitchAlignmentMap].GCLTextPitchAlignmentValue, GCLTextPitchAlignmentMap);
    XCTAssertEqual([NSValue valueWithGCLTextPitchAlignment:GCLTextPitchAlignmentViewport].GCLTextPitchAlignmentValue, GCLTextPitchAlignmentViewport);
    XCTAssertEqual([NSValue valueWithGCLTextPitchAlignment:GCLTextPitchAlignmentAuto].GCLTextPitchAlignmentValue, GCLTextPitchAlignmentAuto);
    ...
    XCTAssertEqual([NSValue valueWithGCLTextRotationAlignment:GCLTextRotationAlignmentViewport].GCLTextRotationAlignmentValue, GCLTextRotationAlignmentViewport);
    XCTAssertEqual([NSValue valueWithGCLTextRotationAlignment:GCLTextRotationAlignmentAuto].GCLTextRotationAlignmentValue, GCLTextRotationAlignmentAuto);
    XCTAssertEqual([NSValue valueWithMGLTextTransform:MGLTextTransformNone].MGLTextTransformValue, MGLTextTransformNone);
    XCTAssertEqual([NSValue valueWithGCLTextTransform:GCLTextTransformUppercase].GCLTextTransformValue, GCLTextTransformUppercase);
    XCTAssertEqual([NSValue valueWithGCLTextTransform:GCLTextTransformLowercase].GCLTextTransformValue, GCLTextTransformLowercase);
    ...
    XCTAssertEqual([NSValue valueWithGCLIconTranslationAnchor:GCLIconTranslationAnchorViewport].GCLIconTranslationAnchorValue, GCLIconTranslationAnchorViewport);
    ...
    XCTAssertEqual([NSValue valueWithGCLTextTranslationAnchor:GCLTextTranslationAnchorViewport].MGLTextTranslationAnchorValue, GCLTextTranslationAnchorViewport);
}
