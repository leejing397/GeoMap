...
- (void)testProperties {
    ...
    // raster-contrast
    {
        ...
        GCLTransition rasterContrastTransition = layer.rasterContrastTransition;
    ...
    // raster-fade-duration
    {
        ...
        GCLTransition rasterFadeDurationTransition = layer.rasterFadeDurationTransition;
    ...
    // raster-opacity
    {
        ...
        GCLTransition rasterOpacityTransition = layer.rasterOpacityTransition;
    ...
    // raster-saturation
    {
        ...
        GCLTransition rasterSaturationTransition = layer.rasterSaturationTransition;
