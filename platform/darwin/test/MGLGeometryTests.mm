...
- (void)testCoordinateBoundsIsEmpty {
    GCLCoordinateBounds emptyBounds = GCLCoordinateBoundsMake(CLLocationCoordinate2DMake(0, 0), CLLocationCoordinate2DMake(10, 0));
    XCTAssertTrue(MGLCoordinateBoundsIsEmpty(emptyBounds));
    XCTAssertFalse(GCLCoordinateSpanEqualToCoordinateSpan(GCLCoordinateSpanZero, MGLCoordinateBoundsGetCoordinateSpan(emptyBounds)));
}
...
- (void)testGeometryBoxing {
    ...
    CLLocationCoordinate2D roundTrippedCoordinate = [NSValue valueWithMGLCoordinate:coordinate].GCLCoordinateValue;
    ...
    GCLCoordinateSpan span = GCLCoordinateSpanMake(4.383333333333335, -4.299999999999997);
    GCLCoordinateSpan roundTrippedSpan = [NSValue valueWithMGLCoordinateSpan:span].GCLCoordinateSpanValue;
    ...
    GCLCoordinateBounds bounds = GCLCoordinateBoundsMake(CLLocationCoordinate2DMake(38.9131982, -77.0325453144239),
                                                         CLLocationCoordinate2DMake(37.7757368, -122.4135302));
    GCLCoordinateBounds roundTrippedBounds = [NSValue valueWithGCLCoordinateBounds:bounds].GCLCoordinateBoundsValue;
...
- (void)testCoordinateInCoordinateBounds {
    ...
    GCLCoordinateBounds wyoming = GCLCoordinateBoundsMake(sw, ne);
...
- (void)testGeoJSONDeserialization {
    ...
    NSError *error;
    GCLPointFeature *feature = (GCLPointFeature *)[GCLShape shapeWithData:data encoding:NSUTF8StringEncoding error:&error];
    ...
    XCTAssertTrue([feature isKindOfClass:[GCLPointFeature class]], @"Valid GeoJSON point feature data should produce an MGLPointFeature.");
...
- (void)testMGLCoordinateBoundsToMGLCoordinateQuad {
    GCLCoordinateBounds bounds = GCLCoordinateBoundsMake(CLLocationCoordinate2DMake(37.936, -80.425),
                                                         CLLocationCoordinate2DMake(46.437, -71.516));

    GCLCoordinateQuad quad = MGLCoordinateQuadFromCoordinateBounds(bounds);
    XCTAssertEqualObjects([NSValue valueWithMGLCoordinate:bounds.sw],
