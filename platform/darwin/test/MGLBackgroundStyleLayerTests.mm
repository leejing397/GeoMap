...
- (void)testProperties {
    ...
    // background-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.backgroundColor;
        ...
        functionStyleValue = [MGLStyleValue<GCLColor *> valueWithInterpolationMode:MGLInterpolationModeIdentity sourceStops:nil attributeName:@"" options:nil];
        ...
        functionStyleValue = [MGLStyleValue<GCLColor *> valueWithInterpolationMode:MGLInterpolationModeInterval compositeStops:@{@18: constantStyleValue} attributeName:@"" options:nil];
        XCTAssertThrowsSpecificNamed(layer.backgroundColor = functionStyleValue, NSException, NSInvalidArgumentException, @"MGLStyleValue should raise an exception if it is applied to a property that cannot support it");
        ...
        GCLTransition backgroundColorTransition = layer.backgroundColorTransition;
    ...
    // background-opacity
    {
        ...
        GCLTransition backgroundOpacityTransition = layer.backgroundOpacityTransition;
    ...
    // background-pattern
    {
        ...
        GCLTransition backgroundPatternTransition = layer.backgroundPatternTransition;
