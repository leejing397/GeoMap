...
- (void)testInvalidation {
    ...
    XCTAssertEqual(invalidPack.state, GCLOfflinePackStateInvalid, @"Offline pack should be invalid when initialized independently of MGLOfflineStorage.");
...
- (void)testProgressBoxing {
    ...
    GCLOfflinePackProgress roundTrippedProgress = [NSValue valueWithGCLOfflinePackProgress:progress].GCLOfflinePackProgressValue;
