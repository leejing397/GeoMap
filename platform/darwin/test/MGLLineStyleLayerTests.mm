...
- (void)testPredicates {
    ...
    GCLLineStyleLayer *layer = [[GCLLineStyleLayer alloc] initWithIdentifier:@"layerID" source:source];
...
- (void)testProperties {
    ...
    // line-blur
    {
        ...
        GCLTransition lineBlurTransition = layer.lineBlurTransition;
    ...
    // line-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.lineColor;
        ...
        GCLTransition lineColorTransition = layer.lineColorTransition;
    ...
    // line-gap-width
    {
        ...
        GCLTransition lineGapWidthTransition = layer.lineGapWidthTransition;
    ...
    // line-offset
    {
        ...
        GCLTransition lineOffsetTransition = layer.lineOffsetTransition;
    ...
    // line-opacity
    {
        ...
        GCLTransition lineOpacityTransition = layer.lineOpacityTransition;
    ...
    // line-pattern
    {
        ...
        GCLTransition linePatternTransition = layer.linePatternTransition;
    ...
    // line-width
    {
        ...
        GCLTransition lineWidthTransition = layer.lineWidthTransition;
...
- (void)testValueAdditions {
    ...
    XCTAssertEqual([NSValue valueWithGCLLineCap:GCLLineCapRound].GCLLineCapValue, GCLLineCapRound);
    XCTAssertEqual([NSValue valueWithGCLLineCap:GCLLineCapSquare].GCLLineCapValue, GCLLineCapSquare);
    XCTAssertEqual([NSValue valueWithMGLLineJoin:MGLLineJoinBevel].MGLLineJoinValue, MGLLineJoinBevel);
    XCTAssertEqual([NSValue valueWithGCLLineJoin:GCLLineJoinRound].GCLLineJoinValue, GCLLineJoinRound);
    XCTAssertEqual([NSValue valueWithGCLLineJoin:GCLLineJoinMiter].GCLLineJoinValue, GCLLineJoinMiter);
    ...
    XCTAssertEqual([NSValue valueWithGCLLineTranslationAnchor:GCLLineTranslationAnchorViewport].GCLLineTranslationAnchorValue, GCLLineTranslationAnchorViewport);
}
