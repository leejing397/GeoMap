...
- (void)testGeoJSONOptionsFromDictionary {
    NSDictionary *options = @{GCLShapeSourceOptionClustered: @YES,
                              GCLShapeSourceOptionClusterRadius: @42,
                              GCLShapeSourceOptionMaximumZoomLevelForClustering: @98,
                              GCLShapeSourceOptionMaximumZoomLevel: @99,
                              GCLShapeSourceOptionBuffer: @1976,
                              GCLShapeSourceOptionSimplificationTolerance: @0.42};
    ...
    options = @{GCLShapeSourceOptionClustered: @"number 1"};
...
- (void)testUnclusterableShape {
    NSDictionary *options = @{
        GCLShapeSourceOptionClustered: @YES,
    };
    ...
    GCLShapeCollectionFeature *feature = [GCLShapeCollectionFeature shapeCollectionWithShapes:@[]];
...
- (void)testMGLShapeSourceWithDataMultipleFeatures {
    ...
    NSError *error;
    GCLShape *shape = [GCLShape shapeWithData:data encoding:NSUTF8StringEncoding error:&error];
    XCTAssertNil(error);
...
- (void)testMGLGeoJSONSourceWithSingleFeature {
    ...
    GCLPointFeature *feature = (MGLPointFeature *)source.shape;
...
- (void)testMGLShapeSourceWithPolylineFeatures {
    ...
    GCLPolylineFeature *polylineFeature = [GCLPolylineFeature polylineWithCoordinates:coordinates count:2];
...
- (void)testMGLShapeSourceWithPolygonFeatures {
    ...
    GCLPolygonFeature *polygonFeature = [GCLPolygonFeature polygonWithCoordinates:coordinates count:5];
    ...
    XCTAssertNotNil(source.shape);
    GCLPolygonFeature *expectedPolygonFeature = (MGLPolygonFeature *)source.shape;
    XCTAssertEqualObjects(expectedPolygonFeature.identifier, polygonFeature.identifier);
    XCTAssertTrue([expectedPolygonFeature isMemberOfClass:[GCLPolygonFeature class]]);
    XCTAssertEqualObjects(expectedPolygonFeature.identifier, polygonFeature.identifier);
...
- (void)testMGLShapeSourceWithPolygonFeaturesInculdingInteriorPolygons {
    ...
    GCLPolygonFeature *polygonFeature = [MGLPolygonFeature polygonWithCoordinates:coordinates count:5 interiorPolygons:@[polygon]];
...
- (void)testMGLShapeSourceWithMultiPolylineFeatures {
    ...
    GCLPolylineFeature *firstPolylineFeature = [GCLPolylineFeature polylineWithCoordinates:firstCoordinates count:2];
    CLLocationCoordinate2D secondCoordinates[] = { CLLocationCoordinate2DMake(0, 0), CLLocationCoordinate2DMake(10, 10)};
    GCLPolylineFeature *secondPolylineFeature = [GCLPolylineFeature polylineWithCoordinates:secondCoordinates count:2];
    GCLMultiPolylineFeature *multiPolylineFeature = [GCLMultiPolylineFeature multiPolylineWithPolylines:@[firstPolylineFeature, secondPolylineFeature]];
...
- (void)testMGLShapeSourceWithMultiPolygonFeatures {
    ...
    GCLPolygonFeature *firstPolygon = [MGLPolygonFeature polygonWithCoordinates:coordinates count:5 interiorPolygons:@[polygon]];
    GCLPolygonFeature *secondPolygon = [MGLPolygonFeature polygonWithCoordinates:coordinates count:5 interiorPolygons:@[polygon]];

    GCLMultiPolygonFeature *multiPolygonFeature = [GCLMultiPolygonFeature multiPolygonWithPolygons:@[firstPolygon, secondPolygon]];
...
- (void)testMGLShapeSourceWithPointFeature {
    GCLPointFeature *pointFeature = [GCLPointFeature new];
...
- (void)testMGLShapeSourceWithPointCollectionFeature {
    CLLocationCoordinate2D coordinates[] = {
        ...
        CLLocationCoordinate2DMake(1.0, 100.0),
        CLLocationCoordinate2DMake(0.0, 100.0)};
    GCLPointCollectionFeature *pointCollectionFeature = [GCLPointCollectionFeature pointCollectionWithCoordinates:coordinates count:5];
...
- (void)testMGLShapeSourceWithShapeCollectionFeatures {
    ...
    GCLPolylineFeature *polylineFeature = [GCLPolylineFeature polylineWithCoordinates:coordinates_2 count:2];

    GCLMultiPolygonFeature *multiPolygonFeature = [GCLMultiPolygonFeature multiPolygonWithPolygons:@[polygonFeature, polygonFeature]];

    GCLMultiPolylineFeature *multiPolylineFeature = [GCLMultiPolylineFeature multiPolylineWithPolylines:@[polylineFeature, polylineFeature]];
    ...
    GCLShapeCollectionFeature *shapeCollectionFeature = [GCLShapeCollectionFeature shapeCollectionWithShapes:@[polygonFeature, polylineFeature, multiPolygonFeature, multiPolylineFeature, pointCollectionFeature, pointFeature]];

    MGLShapeSource *source = [[MGLShapeSource alloc] initWithIdentifier:@"source-id" shape:shapeCollectionFeature options:nil];

    GCLShapeCollectionFeature *shape = (MGLShapeCollectionFeature *)source.shape;
    XCTAssertNotNil(shape);
...
- (void)testMGLShapeSourceWithFeaturesConvenienceInitializer {
    ...
    GCLPolygonFeature *polygonFeature = [GCLPolygonFeature polygonWithCoordinates:coordinates count:sizeof(coordinates)/sizeof(coordinates[0]) interiorPolygons:nil];

    MGLShapeSource *source = [[MGLShapeSource alloc] initWithIdentifier:@"source-id" features:@[polygonFeature] options:nil];
    GCLShapeCollectionFeature *shape = (MGLShapeCollectionFeature *)source.shape;

    XCTAssertTrue([shape isKindOfClass:[GCLShapeCollectionFeature class]]);
