...
- (void)testProperties {
    ...
    // fill-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.fillColor;
        ...
        GCLTransition fillColorTransition = layer.fillColorTransition;
    ...
    // fill-opacity
    {
        ...
        GCLTransition fillOpacityTransition = layer.fillOpacityTransition;
    ...
    // fill-outline-color
    {
        ...
        MGLStyleValue<GCLColor *> *defaultStyleValue = layer.fillOutlineColor;
        ...
        GCLTransition fillOutlineColorTransition = layer.fillOutlineColorTransition;
    ...
    // fill-pattern
    {
        ...
        GCLTransition fillPatternTransition = layer.fillPatternTransition;
...
- (void)testValueAdditions {
    XCTAssertEqual([NSValue valueWithGCLFillTranslationAnchor:MGLFillTranslationAnchorMap].GCLFillTranslationAnchorValue, MGLFillTranslationAnchorMap);
    XCTAssertEqual([NSValue valueWithGCLFillTranslationAnchor:GCLFillTranslationAnchorViewport].GCLFillTranslationAnchorValue, GCLFillTranslationAnchorViewport);
}
