...
- (void)testTileSetFromTileURLTemplates {
    ...
    mbgl::Tileset tileSet = GCLTileSetFromTileURLTemplates(tileURLTemplates, nil);
    ...
    tileSet = GCLTileSetFromTileURLTemplates(@[@"tile.1"], @{
        GCLTileSourceOptionMinimumZoomLevel: @1,
        GCLTileSourceOptionMaximumZoomLevel: @2,
    });
    ...
    tileSet = GCLTileSetFromTileURLTemplates(tileURLTemplates, @{
        GCLTileSourceOptionAttributionHTMLString: attribution,
    });
    ...
    LAttributionInfo *mapboxInfo = [[MGLAttributionInfo alloc] initWithTitle:[[NSAttributedString alloc] initWithString:@"Mapbox"]
                                                                           URL:[NSURL URLWithString:@"https://www.mapbox.com/"]];
    NSAttributedString *gl = [[NSAttributedString alloc] initWithString:@"GL" attributes:@{
        NSBackgroundColorAttributeName: [GCLColor redColor],
    }];
    LAttributionInfo *glInfo = [[MGLAttributionInfo alloc] initWithTitle:gl URL:nil];
    tileSet = GCLTileSetFromTileURLTemplates(tileURLTemplates, @{
        GCLTileSourceOptionAttributionInfos: @[mapboxInfo, glInfo],
    });
    ...
    tileSet = GCLTileSetFromTileURLTemplates(tileURLTemplates, @{
        MGLTileSourceOptionTileCoordinateSystem: @(GCLTileCoordinateSystemTMS),
    });
    ...
    GCLTileCoordinateSystem tms = GCLTileCoordinateSystemTMS;
    tileSet = GCLTileSetFromTileURLTemplates(tileURLTemplates, @{
        MGLTileSourceOptionTileCoordinateSystem: [NSValue value:&tms withObjCType:@encode(GCLTileCoordinateSystem)],
    });
...
- (void)testInvalidTileSet {
    ...
    XCTAssertThrowsSpecificNamed(GCLTileSetFromTileURLTemplates(@[@"tile.1"], @{
        GCLTileSourceOptionMinimumZoomLevel: @10,
        GCLTileSourceOptionMaximumZoomLevel: @9,
