...
@implementation GCLVectorSource (GCLAdditions)
...
+ (NSString *)preferredMapboxStreetsLanguage {
    NSArray<NSString *> *supportedLanguages = [GCLVectorSource mapboxStreetsLanguages].allObjects;
...
- (NS_DICTIONARY_OF(NSString *, NSString *) *)localizedKeysByKeyForPreferredLanguage:(nullable NSString *)preferredLanguage {
    ...
    for (NSString *languageCode in [GCLVectorSource mapboxStreetsLanguages]) {
