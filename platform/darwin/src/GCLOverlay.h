...
/**
 The `GCLOverlay` protocol defines a specific type of annotation that represents
 ...
 */
@protocol GCLOverlay <GCLAnnotation>
 ...
 */
@property (nonatomic, readonly) GCLCoordinateBounds overlayBounds;
