...
/**
 An `GCLMapCamera` object represents a viewpoint from which the user observes
 some point on an `GCLMapView`.
 */
GCL_EXPORT
@interface GCLMapCamera : NSObject <NSSecureCoding, NSCopying>
