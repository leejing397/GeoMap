...
/**
 `GCLVectorStyleLayer` is an abstract superclass for style layers whose content
 is defined by an `GCLShapeSource` or `GCLVectorSource` object.

 Create instances of `GCLCircleStyleLayer`, `GCLFillStyleLayer`,
 `GCLFillExtrusionStyleLayer`, `GCLLineStyleLayer`, and `GCLSymbolStyleLayer` in
 order to use `GCLVectorStyleLayer`'s properties and methods. Do not create
 instances of `GCLVectorStyleLayer` directly, and do not create your own
 subclasses of this class.
 */
GCL_EXPORT
@interface GCLVectorStyleLayer : GCLForegroundStyleLayer
...
/**
 ...
 <tr>
    ...
    <td>
        ...
        consult the documentation for the <code>GCLFeature</code> protocol’s
 ...
 ```swift
 let layer = GCLLineStyleLayer(identifier: "contour", source: terrain)
