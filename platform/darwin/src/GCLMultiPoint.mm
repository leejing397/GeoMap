...
- (BOOL)isEqual:(id)other
{
    ...
    if (![other isKindOfClass:[GCLMultiPoint class]]) return NO;

    GCLMultiPoint *otherMultipoint = other;
...
- (mbgl::Annotation)annotationObjectWithDelegate:(__unused id <GCLMultiPointDelegate>)delegate
{
