...
void MGLPrepareCustomStyleLayer(void *context) {
    GCLOpenGLStyleLayer *layer = (__bridge GCLOpenGLStyleLayer *)context;
...
void MGLDrawCustomStyleLayer(void *context, const mbgl::style::CustomLayerRenderParameters &params) {
    GCLOpenGLStyleLayer *layer = (__bridge GCLOpenGLStyleLayer *)context;
    GCLStyleLayerDrawingContext drawingContext = {
...
/**
 ...
 set to `nil`.
 */
@property (nonatomic, weak, readwrite) GCLStyle *style;

@end

@implementation GCLOpenGLStyleLayer
