...
/**
 Options for `GCLShapeSource` objects.
 */
typedef NSString *GCLShapeSourceOption NS_STRING_ENUM;
 ...
 */
extern GCL_EXPORT const GCLShapeSourceOption GCLShapeSourceOptionClustered;
 ...
 */
extern GCL_EXPORT const GCLShapeSourceOption GCLShapeSourceOptionClusterRadius;

/**
 An `NSNumber` object containing an integer; specifies the maximum zoom level at
 which to cluster points if clustering is enabled. Defaults to one zoom level
 less than the value of `GCLShapeSourceOptionMaximumZoomLevel` so that, at the
 ...
 source property in the Mapbox Style Specification.
 */
extern GCL_EXPORT const GCLShapeSourceOption GCLShapeSourceOptionMaximumZoomLevelForClustering;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
extern GCL_EXPORT const GCLShapeSourceOption GCLShapeSourceOptionMaximumZoomLevel;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
extern GCL_EXPORT const GCLShapeSourceOption GCLShapeSourceOptionBuffer;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
extern GCL_EXPORT const GCLShapeSourceOption GCLShapeSourceOptionSimplificationTolerance;

/**
 `GCLShapeSource` is a map content source that supplies vector shapes to be
 shown on the map. The shapes may be instances of `GCLShape` or `GCLFeature`,
 or they may be defined by local or external
 <a href="http://geojson.org/">GeoJSON</a> code. A shape source is added to an
 `GCLStyle` object along with an `GCLVectorStyleLayer` object. The vector style
 ...
 `GCLShapeSource` object that you can use to refine the map’s content and
 initialize new style layers. You can also add and remove sources dynamically
 using methods such as `-[GCLStyle addSource:]` and
 `-[GCLStyle sourceWithIdentifier:]`.
 ...
 let polyline = GCLPolylineFeature(coordinates: &coordinates, count: UInt(coordinates.count))
 let source = GCLShapeSource(identifier: "lines", features: [polyline], options: nil)
 mapView.style?.addSource(source)
 ```
 */
GCL_EXPORT
@interface GCLShapeSource : GCLSource
 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier URL:(NSURL *)url options:(nullable NS_DICTIONARY_OF(GCLShapeSourceOption, id) *)options NS_DESIGNATED_INITIALIZER;

/**
 Returns a shape source with an identifier, a shape, and dictionary of options
 for the source.

 To specify attributes about the shape, use an instance of an `GCLShape`
 subclass that conforms to the `GCLFeature` protocol, such as `GCLPointFeature`.
 To include multiple shapes in the source, use an `GCLShapeCollection` or
 `GCLShapeCollectionFeature` object, or use the
 ...
 `+[GCLShape shapeWithData:encoding:error:]` method.

 @param identifier A string that uniquely identifies the source.
 @param shape A concrete subclass of `GCLShape`
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier shape:(nullable GCLShape *)shape options:(nullable NS_DICTIONARY_OF(GCLShapeSourceOption, id) *)options NS_DESIGNATED_INITIALIZER;

/**
 Returns a shape source with an identifier, an array of features, and a dictionary
 of options for the source.

 Unlike `-initWithIdentifier:shapes:options:`, this method accepts `GCLFeature`
 instances, such as `GCLPointFeature` objects, whose attributes you can use when
 applying a predicate to `GCLVectorStyleLayer` or configuring a style layer’s
 appearance.
 ...
 @param identifier A string that uniquely identifies the source.
 @param features An array of objects that conform to the GCLFeature protocol.
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
...
/**
 ...
 Any `GCLFeature` instance passed into this initializer is treated as an ordinary
 shape, causing any attributes to be inaccessible to an `GCLVectorStyleLayer` when
 ...
 @param identifier A string that uniquely identifies the source.
 @param shapes An array of shapes; each shape is a member of a concrete subclass of GCLShape.
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
...
/**
 ...
 passed into `-[GCLStyle addSource:]`.
 ...
 */
@property (nonatomic, copy, nullable) GCLShape *shape;
