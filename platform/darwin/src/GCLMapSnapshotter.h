 ...
 */
GCL_EXPORT
@interface GCLMapSnapshotOptions : NSObject
 ...
 */
- (instancetype)initWithStyleURL:(nullable NSURL *)styleURL camera:(GCLMapCamera *)camera size:(CGSize)size;
 ...
 */
@property (nonatomic) GCLMapCamera *camera;
 ...
 */
@property (nonatomic) GCLCoordinateBounds coordinateBounds;
 ...
 */
GCL_EXPORT
@interface GCLMapSnapshot : NSObject
...
/**
 ...
 @param snapshot The `GCLMapSnapshot` that was generated or `nil` if an error occurred.
 @param error The error that occured or `nil` when successful.
 */
typedef void (^GCLMapSnapshotCompletionHandler)(GCLMapSnapshot* _Nullable snapshot, NSError* _Nullable error);
 ...
 */
GCL_EXPORT
@interface GCLMapSnapshotter : NSObject
 ...
 */
- (void)startWithCompletionHandler:(GCLMapSnapshotCompletionHandler)completionHandler;
...
/**
 ...
 @param completionHandler The block to handle the result in.
 */
- (void)startWithQueue:(dispatch_queue_t)queue completionHandler:(GCLMapSnapshotCompletionHandler)completionHandler;
