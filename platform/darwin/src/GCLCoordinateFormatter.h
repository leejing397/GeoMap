...
/**
 The `GCLCoordinateFormatter` class provides properly formatted descriptions of
 ...
 */
GCL_EXPORT
@interface GCLCoordinateFormatter : NSFormatter
...
/**
 This method is not supported for the `GCLCoordinateFormatter` class.
 */
