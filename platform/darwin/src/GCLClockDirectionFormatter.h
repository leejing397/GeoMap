...
/**
 The `GCLClockDirectionFormatter` class provides properly formatted descriptions
 ...
 irrespective of the user’s orientation, use `GCLCompassDirectionFormatter`
 instead.
 */
GCL_EXPORT
@interface GCLClockDirectionFormatter : NSFormatter
