...
@implementation NSValue (GCLStyleAttributeAdditions)
...
{
    NSAssert(strcmp(self.objCType, @encode(GCLSphericalPosition)) == 0, @"Value does not represent an MGLSphericalPosition");
