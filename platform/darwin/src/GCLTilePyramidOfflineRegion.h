 ...
 */
GCL_EXPORT
@interface GCLTilePyramidOfflineRegion : NSObject <GCLOfflineRegion, NSSecureCoding, NSCopying>
...
/**
 ...
 tiles.
 */
@property (nonatomic, readonly) GCLCoordinateBounds bounds;

/**
 The minimum zoom level for which to download tiles and other resources.

 For more information about zoom levels, `-[GCLMapView zoomLevel]`.
 */
...
/**
 ...
 This is the designated initializer for `GCLTilePyramidOfflineRegion`.
 ...
 @param maximumZoomLevel The maximum zoom level to be covered by the downloaded
    ...
    level.
 */
- (instancetype)initWithStyleURL:(nullable NSURL *)styleURL bounds:(GCLCoordinateBounds)bounds fromZoomLevel:(double)minimumZoomLevel toZoomLevel:(double)maximumZoomLevel NS_DESIGNATED_INITIALIZER;
