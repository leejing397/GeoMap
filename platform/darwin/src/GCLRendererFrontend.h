...
/**
 ...
 dependent way.
 */
class GCLRenderFrontend : public mbgl::RendererFrontend
{
public:
    GCLRenderFrontend(std::unique_ptr<mbgl::Renderer> renderer_, GCLMapView* nativeView_, mbgl::RendererBackend& mbglBackend_, bool async = false)
