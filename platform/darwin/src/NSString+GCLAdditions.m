...
@implementation NSString (GCLAdditions)
...
#endif
    [string enumerateLinguisticTagsInRange:string.gcl_wholeRange scheme:NSLinguisticTagSchemeLexicalClass options:0 orthography:orthography usingBlock:^(NSString * _Nonnull tag, NSRange tokenRange, NSRange sentenceRange, BOOL * _Nonnull stop) {
